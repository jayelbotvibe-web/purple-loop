...
echo "  2. Find the VM address (ipconfig on the VM), then:"
echo "       export WINDOWS_SSH_HOST=<address> WINDOWS_SSH_USER=windows-vm"
echo "       ssh \"\$WINDOWS_SSH_USER@\$WINDOWS_SSH_HOST\" hostname  # verify"
